...
var exsol = artifacts.require("ExerciceSolution.sol");
...
module.exports = (deployer, network, accounts) => {
    deployer.then(async () => {
		...
		await deployExsol(deployer, network, accounts);
...
async function deployExsol(deployer, network, accounts) {
	Exsol = await exsol.new()
}
async function deployRecap(deployer, network, accounts) {
	...
	console.log("ExerciceSolution : " + Exsol.address)
}
